...
<div class="container">
    ...
    <form name="form" class="form-horizontal" method="post" action="/system/card/updateSquard" id="form">
        <fieldset>
            ...
            <div class="control-group">
                <label class="control-label">槽位</label>

                <div class="controls">
                    <input type="text" name="minSlot" value="${vo.minSlot}">~<input type="text" name="maxSlot" value="${vo.maxSlot}">
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
